    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex min-w-0 overflow-x-hidden overflow-y-auto w-full">
          ...
          >
            <div className="w-full max-w-[420px] min-w-0 overflow-hidden">
              {/* Logo */}
              <Link to={ROUTES.HOME} className="flex items-center justify-center gap-2 mb-4 sm:mb-6">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#226D68] flex items-center justify-center shrink-0">
              ...
              {/* Boutons sociaux - empilés sur mobile pour éviter le débordement */}
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                <Button
                  type="button"
                  variant="outline"
                  className="w-full sm:flex-1 min-h-[44px] h-11 border-2 border-gray-200 hover:bg-gray-50 text-[#2C2C2C] rounded-lg font-medium text-sm sm:text-base shrink-0"
                ...
                <Button
                  type="button"
                  className="w-full sm:flex-1 min-h-[44px] h-11 bg-[#0A66C2] hover:bg-[#004182] text-white rounded-lg font-medium text-sm sm:text-base shrink-0"
                  onClick={handleLinkedInOAuth}
                  disabled={isLoading}
                >
                  <svg className="w-5 h-5 shrink-0 mr-2" viewBox="0 0 24 24" fill="currentColor">
