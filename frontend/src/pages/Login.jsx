          ...
          <div className="w-full max-w-[420px] min-w-0 overflow-hidden bg-white rounded-xl shadow-lg border border-gray-100 p-6 lg:p-8">
            ...
            <div className="space-y-3 mb-6">
              <Button
                type="button"
                variant="outline"
                className="w-full h-11 border-2 border-gray-200 hover:bg-gray-50 text-[#2C2C2C] rounded-lg font-medium"
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-11 border-2 border-[#0A66C2] bg-[#0A66C2] hover:bg-[#004182] text-white rounded-lg font-medium"
