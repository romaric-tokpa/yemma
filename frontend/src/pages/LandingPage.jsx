        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 md:h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="/how-it-works" className="text-sm text-gray-700 transition-colors font-medium" style={{ '--hover-color': primaryColor }} onMouseEnter={(e) => e.target.style.color = primaryColor} onMouseLeave={(e) => e.target.style.color = '#374151'}>
                Comment ça marche
              </a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t shadow-lg">
            <div className="px-4 py-3 space-y-2">
              ...
              <a href="/how-it-works" className="block text-sm text-gray-700 py-2 transition-colors" style={{ '--hover-color': primaryColor }} onMouseEnter={(e) => e.target.style.color = primaryColor} onMouseLeave={(e) => e.target.style.color = '#374151'} onClick={() => setMobileMenuOpen(false)}>Comment ça marche</a>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs">
                ...
                <li><a href="/how-it-works" className="transition-colors" onMouseEnter={(e) => e.target.style.color = primaryColor} onMouseLeave={(e) => e.target.style.color = '#9CA3AF'}>Comment ça marche</a></li>
